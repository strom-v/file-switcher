...
// команды здесь — короткие non-interactive CLI-вызовы (networksetup/security/openssl), не должны
// висеть дольше пары секунд в норме; таймаут страхует от зависания на системном диалоге авторизации
// или другой аномалии, вместо бесконечно висящего promise
